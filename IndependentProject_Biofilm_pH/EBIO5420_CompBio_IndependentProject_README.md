# **EBIO 5420: Computational Biology Spring 2020**
...
secreted by the bacteria (Branda et al, 2005, 3). Given the importance of pH in determining where some microbes can be found, understanding how biofilm bacterial communities
...
3. Branda, S., Vik, A., Friedman, L., Kolter, R. Biofilms: the matrix revisited. Trends in Microbiology. 2005. 13(1): p. 20 - 26. 
